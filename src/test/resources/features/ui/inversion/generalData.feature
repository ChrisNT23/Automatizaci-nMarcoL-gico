...
Feature: General Data Project
  ...
  Scenario Outline: A user with proper role should be able to create a project
    ...
    Examples:
      ...
      | admin     | presidency | Prueba Proyecto 13/Marzo | Programa         | Estado     | Cantonal | Servicios       | Administración Deporte | 200              | Infraestructura y equipamiento de uso militar | 2024/04/14 | 2025/04/31 | Prioridad    | No           | No         | No          | No                  | No                     | No      | Lionel Messi | Tester               | liomessi@gmail.com | liomessi2@gmail.com | 123456789    | 00000     | Andres Lopez                  | anderslopez@gmail.com   | Cereales | Cereales Chocapic |
