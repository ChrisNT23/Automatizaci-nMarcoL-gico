...
Feature: General Data Project
  ...
  Scenario Outline: A user with proper role should be able to create a project
    ...
    Examples:
      ...
      | admin     | presidency | Prueba Proyecto 16/Abril | Programa         | Estado     | Cantonal | Servicios       | Administración Deporte | 200              | Infraestructura y equipamiento de uso militar | 2024/4/16 | 2025/4/30 | Prioridad    | No           | No         | No          | No                  | No                     | No      | Lionel Messi | Tester               | liomessi@gmail.com | liomessi2@gmail.com | 123456789    | 00000     | Andres Lopez                  | anderslopez@gmail.com   | Cereales | Cereales Chocapic |
